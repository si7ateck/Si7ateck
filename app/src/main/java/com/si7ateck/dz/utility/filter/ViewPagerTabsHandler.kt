...
import com.si7ateck.dz.utility.customview.NoScrollHorizontalLayoutManager
...
class ViewPagerTabsHandler(
    ...
    private val bottomBarPinkColor: Int by bindColor(context, R.color.primaryLightColor)
