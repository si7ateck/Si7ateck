...
class DoctorItemViewModel(application: Application):AndroidViewModel(application) {
    ...
    private val _DiplayDocotors = MutableLiveData<ArrayList<Doctor>>().apply {
        ...
        value!!.add(Doctor(1,"abc","ilyes",Specialty.Chirurgien_Cardiaque,"0540073829","@drawable/images",Type.PRIVATE))
        value!!.add( Doctor(2,"abcd","akram",Specialty.Chirurgie_pediatrique,"0540073829","@drawable/ppng",Type.PRIVATE))
        value!!.add(Doctor(3,"abcde","ilyes",Specialty.Allergologue,"0540073829","@drawable/ppng",Type.PRIVATE))
        value!!.add(Doctor(4,"abcdef","ilyes",Specialty.Allergologue,"0540073829","@drawable/images",Type.PRIVATE))
        value!!.add(Doctor(5,"abcdefg","ilyes",Specialty.Allergologue,"0540073829","@drawable/images",Type.PRIVATE))
    }
    ...
    private val _locationitems = MutableLiveData<ArrayList<Location>>().apply {
        ...
        value!!.add(Location("abc",2.22,0.5,City.SIDI_BEL_ABBES,"dar el berd","2 rue belquace",233))
        value!!.add(Location("abcd",2.223,0.05,City.SIDI_BEL_ABBES,"dar el berd","2 rue belquace",2334))
        value!!.add(Location("abcde",2.225,0.45,City.SIDI_BEL_ABBES,"dar el berd","2 rue belquace",2335))
        value!!.add(Location("abcdef",2.227,0.35,City.SIDI_BEL_ABBES,"dar el berd","2 rue belquace",2337))
        value!!.add(Location("abcdefg",2.228,0.75,City.SIDI_BEL_ABBES,"dar el berd","2 rue belquace",2339))
    }
    ...
    private val _wtitems = MutableLiveData<ArrayList<WorkingTime>>().apply {
        ...
        value!!.add(WorkingTime("abc","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","not workin","not workin"))
        value!!.add(WorkingTime("abcd","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","not workin","not workin"))
        value!!.add(WorkingTime("abcde","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","not workin","not workin"))
        value!!.add(WorkingTime("abcdef","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","not workin","not workin"))
        value!!.add(WorkingTime("abcdefg","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","08:00 - 17:00","not workin","not workin"))
    }
